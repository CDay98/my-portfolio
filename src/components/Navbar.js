...
export default function Navbar() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      setIsScrolled(!isTop && currentScrollPos > prevScrollPos);
  ...
  return (
    <header
      className={`bg-gray-800 md:fixed top-0 w-full z-10 transition-opacity ${
            ...
            >
              <path
                ...
                d="M12,2C6.48,2,2,6.48,2,12c0,4.42,2.86,8.17,6.84,9.49c0.5,0.09,0.68-0.21,0.68-0.48
                      c0-0.24-0.01-0.88-0.01-1.73c-2.49,0.54-3.01-1.2-3.01-1.2c-0.41-1.05-1-1.33-1-1.33c-0.82-0.56,0.06-0.55,0.06-0.55c0.91,0.06,1.39,0.94,1.39,0.94c0.81,1.39,2.13,0.99,2.65,0.76c0.08-0.59,0.31-0.99,0.56-1.22c-1.96-0.22-4.02-0.98-4.02-4.36
